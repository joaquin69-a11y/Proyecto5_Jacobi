...
### 5.3. Descomposición de Dominio y Halos
...
## 6\. Diseño e Implementación Paralela

### 6.1. Descomposición de Dominio
...
### 6.2. Comunicación de Fronteras (Halo Exchange)
...
### 6.4. Recolección de Resultados (I/O)
...
## 8\. Resultados y Análisis de Rendimiento
...
### 8.1. Tabla de Métricas Obtenidas
...
### 8.3. Análisis Crítico del Rendimiento
